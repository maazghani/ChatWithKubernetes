...
// executeCommand executes the provided command string using the shell,
// which properly handles quoted arguments such as JSON payloads.
func executeCommand(commandStr string) (string, error) {
	// Use "sh -c" to let the shell parse and handle quoting correctly.
